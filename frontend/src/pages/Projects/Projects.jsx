...
const Projects = () => {
  ...
  return (
    <div className="w-full h-full py-5  px-5 md:px-10 flex flex-col gap-5 overflow-auto">
      ...
      <div className="grid grid-cols-1 max-sm:place-items-center max-sm:space-y-10 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 space-y-6 space-x-5 mb-2 max-md:mt-5 mt-2">
        {
          data?.map((item, idx)=>(
